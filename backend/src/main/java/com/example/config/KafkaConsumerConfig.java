...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, JsonNode> consumerFactory() {
        ...
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, "localhost:9092"); // Thay bằng địa chỉ Kafka của bạn
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "product-log-group");
